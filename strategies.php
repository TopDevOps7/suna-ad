    ...
    <div class="row flex-row-reverse">
      <div class="col-12 col-sm-7 col-md-9 col-lg-9 col-xl-9 col-xxl-9 px-3 ps-md-4 ps-sm-3 ps-lg-3 ps-xl-4 ps-xxl-5 fs-7">
        ...
        <div class="d-flex justify-content-center mt-5">
          <a href="" class="text-decoration-none d-flex"><button class="btn bg-success text-white text-center px-5 d-flex mx-2 py-2"><?= $ln['free_activation'] ?></button></a>
          <a href="" class="text-decoration-none d-flex"><button class="btn bg-secondary-color text-black text-center px-3 d-flex mx-2 py-2"><?= $ln['start_with_better_fee'] ?></button></a>
        </div>
      </div>
      <div class="col-12 col-sm-5 col-md-3 col-lg-3 col-xl-3 col-xxl-3 px-3 pe-md-4 pe-sm-3 pe-lg-3 pe-xl-4 pe-xxl-5 pt-4">
        <div class="bg-white p-3 rounded shadow-sm h-auto position-relative">
          ...
          <div class="action_buttons px-2 mt-2">
            <a href="" class="text-decoration-none d-flex"><button class="btn bg-primary-color text-white text-uppercase text-center px-1 my-2 fs-7 w-100 px-quto"><?= $ln['history'] ?></button></a>
            <a href="" class="text-decoration-none d-flex"><button class="btn bg-success text-white text-uppercase text-center px-1 my-2 fs-7 w-100 px-quto"><?= $ln['pay_2years'] ?></button></a>
            <a href="" class="text-decoration-none d-flex"><button class="btn bg-secondary-color text-black text-uppercase text-center px-3 my-2 fs-7 w-100 px-quto"><?= $ln['buy_now'] ?></button></a>
          </div>
        </div>
      </div>
    </div>
